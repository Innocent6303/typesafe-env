...
![npm](https://img.shields.io/npm/v/typesafe-env?style=flat-square) ![license](https://img.shields.io/badge/license-MIT-green?style=flat-square)
...
```javascript
import TypeSafeEnv from "typesafe-env";
```
